...
from src.diffmotion.torchscale.component.multiscale_retention import MultiScaleRetention
...
class RetNetDecoder(nn.Module):
    ...
    def forward(
        ...
        # relative position
        retention_rel_pos = self.retnet_rel_pos(slen, activate_recurrent=(incremental_state is not None and not is_first_step),
