...
class EncoderConfig(object):
    def __init__(self, **kwargs):
        self.encoder_embed_dim = kwargs.pop("encoder_embed_dim", 1280)
...
class DecoderConfig(object):
    def __init__(self, **kwargs):
        self.decoder_embed_dim = kwargs.pop("decoder_embed_dim", 1280)
        self.decoder_attention_heads = kwargs.pop("decoder_attention_heads", 16)
...
class RetNetConfig(object):
    def __init__(self, **kwargs):
        self.decoder_embed_dim = kwargs.pop("decoder_embed_dim", 1280) # 1280
        self.decoder_retention_heads = kwargs.pop("decoder_retention_heads", 16)   # default   16
        self.decoder_ffn_embed_dim = kwargs.pop("decoder_ffn_embed_dim", 2560)  # 1280
        self.decoder_layers = kwargs.pop("decoder_layers", 1)                      # default 16
        self.decoder_normalize_before = kwargs.pop("decoder_normalize_before", True)
        self.activation_fn = kwargs.pop("activation_fn", "gelu")
        self.dropout = kwargs.pop("dropout", 0.0)
        self.drop_path_rate = kwargs.pop("drop_path_rate", 0.0)
        ...
        self.max_target_positions = kwargs.pop("max_target_positions", 400)
        self.no_output_layer = kwargs.pop("no_output_layer", False)
        self.layernorm_eps = kwargs.pop("layernorm_eps", 1e-5)
        # Blockwise
        self.chunkwise_recurrent = kwargs.pop("chunkwise_recurrent", False) # ### False
        self.recurrent_chunk_size = kwargs.pop("recurrent_chunk_size", 20)  # #### 512
        # Text
        self.vocab_size = kwargs.pop("vocab_size", -1)
        # Fairscale
        self.checkpoint_activations = kwargs.pop("checkpoint_activations", False)
