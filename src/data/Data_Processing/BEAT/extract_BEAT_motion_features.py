...
def extract_joint_angles(bvh_dir, files, destpath, fps, fullbody=False, map_to_exponential=True,
                         position_smoothing=5, rotation_smoothing=10, constant_remover_eps=1e-6):
    p = BVHParser()
            ...
            data_pipe = Pipeline([
                ...
                ('jtsel', JointSelector(  # 20 Joints + 1 root = 21
                    ['LeftUpLeg', 'LeftLeg', 'LeftFoot', 'LeftForeFoot', 'LeftToeBase', 'LeftToeBaseEnd',
                     ...
                     'RightToeBaseEnd',  'Spine', 'Spine1', 'Spine2', 'Spine3', 'LeftShoulder',
                     'LeftArm', 'LeftForeArm', 'LeftHand', 'LeftHandIndex', 'LeftHandThumb1', 'LeftHandThumb2',
                     'LeftHandThumb3', 'LeftHandThumb4',  'LeftHandIndex1', 'LeftHandIndex2',
                     'LeftHandIndex3', 'LeftHandIndex4',  'LeftHandRing', 'LeftHandPinky',
                     'LeftHandPinky1', 'LeftHandPinky2', 'LeftHandPinky3', 'LeftHandPinky4',
                     'LeftHandRing1', 'LeftHandRing2', 'LeftHandRing3', 'LeftHandRing4',
                     'LeftHandMiddle1', 'LeftHandMiddle2', 'LeftHandMiddle3', 'LeftHandMiddle4',
                     'RightShoulder', 'RightArm', 'RightForeArm', 'RightHand', 'RightHandIndex', 'RightHandThumb1',
                     'RightHandThumb2', 'RightHandThumb3', 'RightHandThumb4',  'RightHandIndex1',
                     'RightHandIndex2', 'RightHandIndex3', 'RightHandIndex4',  'RightHandRing',
                     'RightHandPinky', 'RightHandPinky1', 'RightHandPinky2', 'RightHandPinky3', 'RightHandPinky4',
                      'RightHandRing1', 'RightHandRing2', 'RightHandRing3', 'RightHandRing4',
                      'RightHandMiddle1', 'RightHandMiddle2', 'RightHandMiddle3',
                     'RightHandMiddle4',  'Neck', 'Neck1', 'Head', 'HeadEnd'],
                    include_root=True)),
                # ('jtsel', JointSelector(  # 20 Joints + 1 root = 21
